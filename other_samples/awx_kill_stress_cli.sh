...
echo "running command: awx job_template launch kill-stress-processes -f human --monitor --limit $event_fqdn"

awx job_template launch kill-stress-processes -f human --monitor \
  --limit $event_fqdn
